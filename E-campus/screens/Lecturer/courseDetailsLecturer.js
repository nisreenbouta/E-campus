              ...
              <View style={styles.smallcard}>
                  <Image
                    ...
                    <View style={styles.cardIconContainer}>
                        <View style={styles.cardIcon}><Entypo name="dots-three-horizontal" size={13} color="#1F3D75"/></View>
                        <View style={styles.cardIcon}><Feather name="edit-2" size={13} color="#1F3D75"/></View>
                        <View style={styles.cardIcon}><AntDesign name="delete" size={13} color="#1F3D75"/></View>
                    </View>
